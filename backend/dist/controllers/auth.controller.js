...
class AuthController {
    ...
    async me(req, res, next) {
        try {
            ...
            throw new ApiError("User is not singed in", StatusCodesEnum.UNAUTHORIZED);
        }
    }
    async refresh(req, res, next) {
        try {
            ...
            res.status(StatusCodesEnum.OK).json({ tokens: tokens });
        }
        catch (e) {
            next(e);
        }
    ...
    async recoveryRequest(req, res, next) {
        try {
