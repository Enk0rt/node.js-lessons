...
router.post("/recovery", commonMiddleware.validateBody(RecoveryValidator.emailSchema), authController.recoveryRequest);
router.post("/recovery/:token", authController.recoveryPassword, commonMiddleware.validateBody(AuthValidator.validatePassword));
